	...
	public function render_page() {
		...
		<div class="wrap coywolf-cdv-settings">
			...
			<form method="post" action="options.php">
				...
				<h2><?php esc_html_e( 'Claude API', 'coywolf-data-visualizer' ); ?></h2>
				<p><?php esc_html_e( 'Chart suggestions are generated by Claude. Create an API key in the Anthropic Console and paste it here.', 'coywolf-data-visualizer' ); ?></p>
